...
WARNING: This token can't be shared, is not provided and is only used for test purpouses. In production environment must be stored safe, like environment variables.
